...
<body>
	<center>
		<a href="<?php echo base_url('d/Exportdata/export_penjualan_excel?startdate='.$startdate.'&enddate='.$enddate.'&status='.$status.'');?>"><button>Export Excel</button></a>
		<a href="<?php echo base_url('d/Exportdata/export_penjualan_pdf?startdate='.$startdate.'&enddate='.$enddate.'&status='.$status.'');?>"><button>Export PDF dan Print</button></a>
	</center>
	<center>
